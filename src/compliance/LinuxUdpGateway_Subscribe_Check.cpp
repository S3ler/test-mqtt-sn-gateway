...
TEST_F(LinuxUdpGateway_Subscribe_Check, Subscribe_knownTopicId_returnSuback) {
    ...
    mqtt_sn_sender.send_subscribe(dup, qos, retain, TEST_SHORT_TOPIC_NAME, msg_id, empty_topic, topic_id);
